...
const ChatRoom = () => {
  ...
  return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
        <div className="w-full max-w-md h-[700px] bg-white rounded-lg shadow flex flex-col">
          <div className="bg-white px-6 py-4 text-xl font-bold border-b text-center">
            채팅방 #{roomId}
          </div>

          <div ref={messagesEndRef} className="flex-1 overflow-y-auto px-4 py-2">
          ...
          <div className="p-4 bg-white border-t flex gap-2">
            ...
            />
            <button onClick={sendMessage} className="bg-blue-600 text-white px-5 py-2 rounded-2xl font-semibold shadow">
              전송
            </button>
          </div>
        </div>
